...
console.log("Return the maximum number of items you could possibly buy");
...
console.log("Return the number that you are on when all of the digits 0-9 have been discovered");
